...
<div class="content-container ">
 ...
 <!-- banner -->
     <section>
         <div class="container-fluid">
             <div class="row bg-info justify-content-center align-items-center" style="height: 60vh">
                <div class="col-sm-10 text-center">
                    <h1 class="display-2 text-capitalize"><span class="text-warning"> </span>reset link sent successfully to your registered mail id<span class="text-white font-weight-bold"></span></h1>
                </div>
             </div>
         </div>
     </section>
