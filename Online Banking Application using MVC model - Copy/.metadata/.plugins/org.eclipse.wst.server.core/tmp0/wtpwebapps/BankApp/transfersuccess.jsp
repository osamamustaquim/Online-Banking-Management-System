         ...
         <div class="container-fluid">
             <div class="row bg-info justify-content-center align-items-center" style="height: 68vh">
                <div class="col-sm-10 text-center">
                    <h1 class="display-2 text-capitalize"><span class="text-warning"> </span><h1>Amount transaction was successful</h1><span class="text-white font-weight-bold"></span></h1>
                </div>
             </div>
         </div>
     </section>
