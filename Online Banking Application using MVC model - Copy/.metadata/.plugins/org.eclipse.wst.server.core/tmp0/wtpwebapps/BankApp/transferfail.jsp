         ...
         <div class="container-fluid">
             <div class="row bg-info justify-content-center align-items-center" style="height: 80vh">
                <div class="col-sm-10 text-center">
                    <h1 class="display-2 text-capitalize"><span class="text-warning">failed to transfer fund </span><span class="text-white font-weight-bold"></span></h1>
                </div>
             </div>
         </div>
     </section>
