					...
					<div class="row">
						<div class="col-md-4 col-md-offset-3">
							...
							<div class="card-header  ">
								<h1 class="card-title">
									<span class="text-warning"> <h3></h3><b>Change Password</b></h3>
									</span>
								</h1>
							</div>
							<br>
									...
									<div class="form-group">
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												name="nforgotpwd" class="form-control">
										</div>
									</div>
									<div class="row">
										<div class="col">
										...
										<div class="col">
											<a href="login.html" class="btn btn-lg btn-warning btn-block">Cancel</a>
										</div>
									</div>
								</fieldset>
							</form>
